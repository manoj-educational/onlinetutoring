<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.master" AutoEventWireup="true" CodeFile="DownloadPdf.aspx.cs" Inherits="Student_DownloadPdf" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="tbl">
        <tr>
            ...
            &nbsp;Branch PDF Material for Study.</td>
        </tr>
        <tr>
            <td>
                Your Course :
        ...
        <tr>
            <td>
                Select Teacher :
                <asp:DropDownList ID="drpteacher" runat="server" CssClass="txt">
                </asp:DropDownList>
&nbsp;<asp:Button ID="btnsearch" runat="server" CssClass="btn" onclick="btnsearch_Click" 
        ...
        <tr>
            <td>
                ...
                DataKeyNames="vid" onrowcommand="GvUpload_RowCommand" style="text-align: center">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="staff" HeaderText="Staff" />
                         ...
                         <asp:TemplateField HeaderText="Read">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" Text="Read" ID="lnkread" CommandName="read" Font-Bold="true" CommandArgument='<%#Eval("vid") %>' ></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
